...
* How to run USQL scripts
  * Make sure you have selected your Data Lake account
    ...
    ![Select your Data Lake account in Visual Studio](media/select-data-lake-analytics-account.png)

  * Build the script first to validate syntax

    ![Build USQL script in Visual Studio](media/build-usql-script.png)

  * Submit your script to your Data Lake account

    ![Submit USQL script in Visual Studio](media/submit-usql-script.png)

* How to view USQL results in Azure portal

    ![Azure Data lake Analytics Data explorer](media/view-usql-script-results-1.png)

    ![Azure Data lake Analytics Data explorer](media/view-usql-script-results-2.png)
...
*  Enter your ADL information and parameters corrisponding to your scripts
    ...
    ![Sample template load](media/configure-power-bi-client.png)
